                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                <div>
                                    <h3 class="m-0">Start learning Arabic</h3>
                                </div>
                                ...
                                <div class="pt-5">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <input type="email" id="inputEmail" class="form-control" placeholder="Email address or username"/>
                                        </div>
                                ...
                                <div class="form-footer text-muted">
                                    <div class="pt-4 icons text-center">
                                        <div>
                                        ...
                                        <div class="pt-2">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                    <path d="M320,85.333h64c5.891,0,10.667-4.776,10.667-10.667v-64C394.667,4.776,389.891,0,384,0h-64
                                    ...
                                    <div class="pt-5">
                                        ...
                                        <span class="text-uppercase font-weight-bold"><a href="">login</a></span>
                                    </div>

                                    <div class="pt-3">
                                        <span>By creating an Account, you agree to our User Agreement and </span>
                                        <span class="font-weight-bold"><a href="">Privacy Policy</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
