            ...
            <div class="col-md-6 col-lg-4 px-4 py-md-2 px-md-1">
                <div class="fa-card-md pb-3">
                    ...
                    <div class="text-center px-4">
                        ...
                        <!-- <div class="pt-5">
                            <span class="px-4">
                                <button class="fa-card-btn btn btn-outline-secondary text-uppercase font-weight-bold" type="">proflie</button>
                            </span>
                            <span class="px-4">
                                <button class="fa-card-btn btn btn-secondary text-uppercase text-capitalize">
...
<style>
    ...
    @media(max-width: 767px){
        ...
        .col-md-6:first-child .fa-card-md{
            border-width: 1px 0;
        }
    }

    .fa-card-header .like button.btn{
        transition: all 200ms;
    }

    .fa-card-header .like button.btn:hover {
        transform: scale(1.1);
    }
    .fa-card-header .like svg{
        height: 20px;
        width: 20px;
    }

    .fa-card-header .status-bar{
        color: #fff;
